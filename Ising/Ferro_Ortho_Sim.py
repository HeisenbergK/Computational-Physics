...
def make_whole_simulation(T):
    model = Ising(T, lattice, iterations, mesh="ortho", prop="ferro", plots=False)
...
if __name__ == "__main__":
    ...
    df.to_csv(
        f"Ising/Results/Ferro_Ortho_{lattice}_{iterations}_Simulation_{temperature_points}.csv",
        index=False,
    )
